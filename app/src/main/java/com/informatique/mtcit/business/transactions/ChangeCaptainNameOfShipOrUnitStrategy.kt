...
class ChangeCaptainNameOfShipOrUnitStrategy @Inject constructor(
    ...
    override fun getSteps(): List<StepData> {
        ...
        // Step 4: Sailing Regions and Sailor Info
        // Build sailing regions step and inject any pre-populated selection from accumulatedFormData
        val sailingStep = SharedSteps.sailingRegionsStep(sailingRegions = sailingRegionsOptions.map { it.nameAr })
    ...
    override fun extractCompletedStepsFromApiResponse(response: Any): Set<StepType> {
        // TODO: Parse the response object to determine completed steps
        val completedSteps = mutableSetOf<StepType>()

        println("⚠️ CaptainNameChangeStrategy: extractCompletedStepsFromApiResponse not yet implemented")
